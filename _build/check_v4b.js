...
(async () => {
  ...
  await p.goto('file:///Users/huizidemac/WorkBuddy/2026-09-19-21-23-47/全球选品平台.html');
  ...
  await p.evaluate(() => {
    ...
    if (btn) btn.click();
    const btn2 = [...document.querySelectorAll('button')].find(e => (e.innerText || '').trim() === '查看全部结论');
    if (btn2) btn2.click();
  });
  await p.waitForTimeout(1200);
